        ...
        <div id="content-wrap">
            ...
            <div class="container1">
                <div class="box1" style="flex: 3; padding: 10px;" >
                    ...
                    <br>
                    <h3 style="text-align: left">What if I need a longer appointment?</h3>
                    <p class="normal" style="font-size: 20px; text-align: justify;">
                    The doctor will suggest booking a follow up appointment, if you need more time with the doctor.
                    </p>
                    <br>
                    <h3 style="text-align: left">What if I need to change the appointment?</h3>
                    <p class="normal" style="font-size: 20px; text-align: justify;">
                    You can email to us for the changing the appointment date.
                    </p>
                    <br>
                </div>
                <div class="box2">
            ...
            <p style="text-align: center">Still have more questions? <a href="contactUS.php">Contact</a> us!</p>
        </div>
    </div>
